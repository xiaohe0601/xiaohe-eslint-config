...
const isCwdInScope = isPackageExists("@xiaohe01/eslint-config");
 ...
 * @example
 * ```ts
 * import { renameRules } from '@xiaohe01/eslint-config'
 *
 * export default [{
 *   rules: renameRules(
 *     {
 ...
 * @example
 * ```ts
 * import { renamePluginInConfigs } from '@xiaohe01/eslint-config'
